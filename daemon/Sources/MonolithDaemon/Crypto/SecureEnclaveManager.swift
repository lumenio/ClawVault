...
actor SecureEnclaveManager {
    ...
    private let keychainService = "com.monolith.secureenclave.keys"
    private let signingAccount = "signing"
    private let adminAccount = "admin"
    private let legacySigningTag = "com.monolith.signing"
    private let legacyAdminTag = "com.monolith.admin"
